...
function displayRooms() {
    ...
    if (availableRooms.length === 0) {
        roomsList.innerHTML = '<p style="color: var(--text-secondary); font-size: 1.2em;">No rooms available at the moment.</p>';
        return;
    }
...
function displayBookings() {
    ...
    if (hotel.bookings.length === 0) {
        bookingsList.innerHTML = '<p style="color: var(--text-secondary); font-size: 1.2em;">No bookings found.</p>';
        return;
    }
